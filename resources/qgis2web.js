...
var map = new ol.Map({
    ...
    layers: layersList,
    view: new ol.View({
        extent: [13170107.182723, 2805724.696434, 13172168.243534, 2807146.448747], maxZoom: 20, minZoom: 1
    })
});
...
map.getView().fit([13170107.182723, 2805724.696434, 13172168.243534, 2807146.448747], map.getSize());
